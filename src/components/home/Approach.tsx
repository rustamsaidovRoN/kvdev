...
const PRINCIPLES = [
  {
    n: "01",
    title: "Архітектура",
    text: "Співпрацюємо з провідними бюро й ставимося до кожного фасаду як до частини міського ландшафту.",
  },
  {
    n: "02",
    title: "Матеріали",
  ...
  },
  {
    n: "03",
    title: "Локація",
    text: "Обираємо ділянки у знакових районах Києва, де історія та інфраструктура вже сформовані.",
  },
  {
    n: "04",
    title: "Сервіс",
    text: "Приватний консьєрж, керуюча компанія та підтримка мешканця протягом усього життя будинку.",
  },
];
        ...
        <div className="grid gap-10 md:grid-cols-12 md:items-end">
          <Reveal className="md:col-span-8">
            ...
            <h2 className="max-w-3xl text-balance font-display font-light leading-[1.08] text-[clamp(1.8rem,4.2vw,3.4rem)]">
              Чотири принципи, що визначають кожен наш будинок.
            </h2>
          </Reveal>
        </div>
