...
export const projects: Project[] = [
  ...
  },
  {
    ...
    statusKey: "sale",
    featured: true,
    lead: "Дев'ять резиденцій у сучасному японському стилі на березі річки Козинка з інфраструктурою 5* заміського клубного готелю.",
    description: [
      "Це зразок справжньої колекційної нерухомості. Подібні проєкти існують поза часом, поза конкуренцією та поза ринковими циклами. Саме тому вони завжди мають попит і зберігають свою цінність.",
    ],
    specs: [
      { label: "Площа", value: "1 га" },
      { label: "Резиденції", value: "9" },
      { label: "Площа будинків", value: "від 229 м²" },
      { label: "Поверховість", value: "2" },
      { label: "Набережна", value: "120 м" },
      { label: "Рік", value: "2026" },
    ],
    features: [
      "Вихід на набережну",
  ...
  },
  {
    ...
    specs: [
      { label: "Площа", value: "2 га" },
      { label: "Резиденції", value: "11" },
      { label: "Площа будинків", value: "від 350 м²" },
      { label: "Поверховість", value: "2" },
      { label: "Набережна", value: "230 м" },
      { label: "Рік", value: "2022" },
    ],
    features: [
      "Приватний пляж і пірс",
      "SPA та літній басейн",
      "Ландшафтний парк-острів",
      "Сервісна вілла & Chef’s Kitchen",
      "П’ятизірковий сервіс 24/7",
      "Закрита клубна територія",
    ],
  ...
  },
  {
    ...
    specs: [
      { label: "Поверхи", value: "3" },
      { label: "Паркінг", value: "Підземний" },
      { label: "Рік", value: "2027" },
    ],
    features: [
      "Приватна територія",
      "Камерна спільнота",
    ...
    gallery: [
      ...
      "/images/project-vo-003.jpg",
      "/images/project-vo-004.jpg",
      "/images/project-vo-005.jpg",
      "/images/project-vo-007.jpg",
    ],
  },
];
