...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Гармонійне поєднання 5 елементів як символізм гармонії життя:",
      "Вода річки Козинки — як потік, як жіноче начало.",
      "Камінь в екстер’єрі маєтків і глиби у парку — як твердість та стабільність, як чоловіче начало.",
      "Бонсай, сакури, дерева, рослини та елементи ландшафту — як символ розвитку та жаги до життя.",
      "Вогонь під час заходу сонця — як символ трансформації та оновлення.",
      "Свіже заміське повітря і тиша — як елемент легкості та спокою.",
    ],
    specs: [
